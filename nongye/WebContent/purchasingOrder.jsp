...
<html>
	<head>
		<meta charset="UTF-8">
		<title>采购订单</title>
	<link rel="stylesheet" type="text/css" media="screen" href="css/order/common.css">
...
<link rel="shortcut icon" type="image/x-icon" href="tt.img/purchase/favicon.ico"/>

<script type="text/javascript">
    var _path = "/" , _rootPath = "http://order.cnhnb.com:80/" , _basePath = "http://order.cnhnb.com:80/";
</script>
</head>
<body myHnCode="MyBuyersOrder_sy">
...
<div class="header clearfix">
    <div class="wrap">
        <a href="#" target="_blank" class="logo"><img src="tt.img/purchase/purchasingOrder/logo_2.jpg"height="40px" /></a>
...
<div class="main wrap frame-main frame-main-sub">
   ...
   <div class="frame-container">
    <form id= "OrderQuery" name="OrderQuery" action="#" method="post">
    ...
    <div class="frame-title mb10">采购订单</div>
    <div class="order-nav" id="buyer-nav">
      <ul>
        ...
        <li  >
        	<a href="javascript:void(0);" data-state="1" data-back="0">待卖家发货 
        	</a>
        </li>
        <li  >
        	<a href="javascript:void(0);" data-state="2">待收货 
        	</a>
        </li>
        <li  >
  ...
  <div class="container">
    <div class="quick-nav">
      <ul class="icon clearfix">
        <li class="i1"><img src="tt.img/purchase/purchasingOrder/quick-nav-icon-1.gif" alt="资源多">
          <p><span>资源多</span><span>海量信息免费发</span></p>
        </li>
        <li class="i2"><img src="tt.img/purchase/purchasingOrder/quick-nav-icon-2.gif" alt="优惠大">
          <p><span>优惠大</span><span>挑战市场超低价</span></p>
        </li>
        <li class="i3"><img src="tt.img/purchase/purchasingOrder/quick-nav-icon-3.gif" alt="销售广">
          <p><span>销售广</span><span>采购便捷一站式</span></p>
        </li>
        <li class="i4"><img src="tt.img/purchase/purchasingOrder/quick-nav-icon-4.gif" alt="更安全">
      ...
      <div class="list clearfix">
        <dl class="clearfix">
          ...
          <dd><a href="#" target="_blank" rel="nofollow">安装手机信农网</a></dd>
        </dl>
        <dl class="clearfix">
          <dt>采购商服务</dt>
          <dd><a href="supplyHall.jsp" target="_blank">找供应</a></dd>
          <dd><a href="lssueProcurement.jsp" target="_blank" rel="nofollow">发布采购</a></dd>
        </dl>
        <dl class="clearfix">
          <dt>供应商服务</dt>
          <dd><a href="procurementHall.jsp" target="_blank">找采购</a></dd>
          <dd><a href="supplyManagement.jsp" target="_blank" rel="nofollow">发布供应</a></dd>
        </dl>
        <dl class="clearfix">
          <dt>交易安全</dt>
    ...
    <div class="ptb20 clearfix">
      ...
      <ul class="foot-nav clearfix">
        ...
        <li><a href="#" target="_blank">品种库</a></li>
        <li><a href="#" target="_blank">网站地图</a></li>
      </ul>
      <div class="copyright">
        <p>湘ICP备13007354号-1  | 服务热线：400-008-8688</p>
        <p>互联网药品信息服务资格证书:(湘)-经营性-2014-0005 湖南信农科技有限公司  <a href="#" target="_blank">营业执照号</a></p>
...
<div class="popup popup-refund-apply">
	...
	<div class="box">
		<div class="title">
			...
			<img src="tt.img/purchase/purchasingOrder/popup-close.jpg" /></a>
		</div>
		<div class="content">
			<h2>提交成功！</h2>
			<p>
...
<div class="popup popup-cancel" id="buyer-cancel" style="display: none;">
    ...
    <div class="box">
        <div class="title">
            <h2>提示</h2>
            <a href="#" class="close"><img src="tt.img/purchase/purchasingOrder/popup-close.jpg" /></a>
        </div>
        <div class="content">
...
<!--<script type='text/javascript' src="http://static.cnhnb.com/4.0/js/supply/jquery.qrcode.min.js"></script>-->
<script type="text/javascript">
